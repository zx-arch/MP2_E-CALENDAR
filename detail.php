...
<body>
    ...
    <div class="form-container">
        <form action="update" method="post">
            <center>
                <img src="App/img/<?= $data['gambar']; ?>" disabled alt="" width=100 height=100 style="border-radius: 10px;"><br>
            </center>        
            <br>
            ...
            <div class="form-group">
                ...
                <input type="text" name="durasi" id="durasi" disabled value="<?= round((int) $data['durasi']/60, 0) . ' Jam '.strval((int) $data['durasi']%60).' menit '; ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="button" class="button-back" onclick="location.href=document.referrer" value="Kembali">
            </div>
        </form>
