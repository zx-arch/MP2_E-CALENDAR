    ...
    <div class="form-container">
        <form action="prosesUpdate" method="post">    
            ...
            <div class="form-group">
                ...
                <input type="number" id="durasi_jam" name="durasi_jam" value="<?= round((int) $data['durasi']/60, 0); ?>"> Jam
                <input type="number" id="durasi_menit" name="durasi_menit" value="<?= (int) $data['durasi']%60; ?>"> Menit
            </div>
